...
void main() async {
  ...
  await FirebaseMessaging.instance.getInitialMessage().then(handlerMessage);
  await FirebaseMessaging.onMessageOpenedApp.listen(handlerMessage);
